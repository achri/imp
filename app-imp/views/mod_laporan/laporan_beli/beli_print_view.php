		...
		<td>
		 <table width="100%" border="0 cellpadding="0" cellspacing="0">
			<tr>
			 ...
			 <span style="font-size:18pt;font-weight:bold;text-decoration:underline;">TRANSAKSI PEMBELIAN</span></td>
			...
			<tr> 
			 <td colspan="3" valign="top" nowrap>
				<table id="ItemPO" width="100%" border="1" cellspacing="0" cellpadding="2">
					...
					<?php 
					if($data_beli->num_rows() > 0):
						$no=1;
						foreach($data_beli->result() as $rowb):
					?>
					<tr   valign="top"> 
						<td align="center" nowrap="nowrap"  ><?php echo $no?>.</td>
						<td nowrap="nowrap" align="center"><?php echo date_format(date_create($rowb->beli_tgl),'d-M-Y H:i:s')?></td>
						<td align="center" nowrap><?php echo $rowb->beli_no?></td>
						<td align="right" nowrap="nowrap"><?php echo number_format($rowb->beli_tot_jml,2)?></td>
						<td align="right" nowrap="nowrap">Rp. <?php echo number_format($rowb->beli_tot_hrg,2)?></td>
                        <!--td align="right" nowrap="nowrap">Rp. <?php //echo number_format($rowb->beli_tot_bayar,2)?></td-->
