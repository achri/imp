...
$(document).ready(function() {
	...
	var grid = grid_content.jqGrid({
		...
		colModel: [ 
			...
			{name:"beli_no",label:"Document",width:70,align:"center"},
			{name:"beli_tot_jml",label:"Tot.Qty",width:70,align:"right",formatter:'number', formatoptions:{thousandsSeparator:","}}, 
			{name:"beli_tot_hrg",label:"Tot.Price",width:70,align:"right",formatter:'currency', formatoptions:{prefix:"Rp. ",thousandsSeparator:","}},
			//{name:"beli_tot_bayar",label:"Paying",width:70,align:"right",formatter:'currency', formatoptions:{prefix:"Rp. ",thousandsSeparator:","}},
		...
		autowidth:true,
		height:'auto',
		caption:'List Buying Transaction',
			...
			*/
			jQuery("#"+subgrid_table_id).jqGrid('navButtonAdd',
				"#"+pager_id,
				{
					...
					onClickButton:function(){ 
						//var beli_id = jQuery("#"+subgrid_table_id).getGridParam('selrow'); 
						if (row_id) {
	...
	grid_content.jqGrid('navGrid',"#pnewapi_beli",
		{view:false,edit:false,add:false,del:false,refresh:false,search:false},
		{closeAfterEdit:true,reloadAfterSubmit:true,mtype: 'POST'},
		{closeAfterAdd:true,reloadAfterSubmit:true,mtype: 'POST'},
		{reloadAfterSubmit:true,mtype: 'POST'},
...
<table id="newapi_beli"></table>
<div id="pnewapi_beli"></div>
