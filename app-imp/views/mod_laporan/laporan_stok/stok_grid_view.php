	...
	var progrid = progrid_content.jqGrid({
		...
		subGridRowExpanded: function(subgrid_id, row_id) { 			
			...
			jQuery("#"+subgrid_table_id).jqGrid({
				...
				gridComplete: function(){ 
					// SET QUERY SESSION PRINT
					$.post("<?php echo site_url($link_controller)?>/cetak_session/inv_history/"+row_id);
					return;
				},
				onSelectRow:function(id) {	
					var gsr = jQuery("#"+subgrid_table_id).jqGrid('getGridParam','selrow'); 
				...
				url:"<?php echo site_url($link_controller)?>/get_data/inv_history/"+row_id,    
				pager: "#"+pager_id, 
				sortname: 'inv_tgl', 
				sortorder: "DESC",
				datatype:'json',
			...
			jQuery("#"+subgrid_table_id).jqGrid('navGrid',"#"+pager_id,{view:false,edit:false, add:false,del:false,search:false,refresh:false},
