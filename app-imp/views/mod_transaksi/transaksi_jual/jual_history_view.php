...
$(document).ready(function() {
	var histgrid = histgrid_content.jqGrid({
		...
		colModel: [ 
			...
			{name:"jual_no",label:"Document",width:120, align:'center'},
			{name:"jual_tot_jml",label:"Tot.Qty",width:30,align:"right",formatter:'number', formatoptions:{thousandsSeparator:","}},
			{name:"jual_tot_hrg",label:"Tot.Price",width:80,align:"right",formatter:'currency', formatoptions:{prefix:"Rp. ",thousandsSeparator:","}},
