...
$(document).ready(function() {
	var jualdetgrid = jualdetgrid_content.jqGrid({
		...
		onSelectRow:function(id) {	
			...
			jualdetgrid_content.jqGrid('GridToForm',gsr,"#beli_form"); 
			beli_selrow();
			change_tot_harga();
			return;
		},
		...
		colModel: [ 
			...
			//{name:"tot_diskon",label:"Tot.Disc",width:80,align:"right",formatter:'currency', formatoptions:{prefix:"Rp. ",thousandsSeparator:","}},
			{name:"harga",label:"Price",width:80,align:"right",formatter:'currency', formatoptions:{prefix:"Rp. ",thousandsSeparator:","}},
			{name:"tot_harga",label:"Tot.Price",width:80,align:"right",formatter:'currency', formatoptions:{prefix:"Rp. ",thousandsSeparator:","}},
			/*
	...
	jualdetgrid_content.jqGrid('navGrid',"#pnewapi_beli_detail",{view:false,edit:false, add:false,del:false,search:false,refresh:false},
	...
	jualdetgrid_content.jqGrid('navButtonAdd',"#pnewapi_beli_detail",
		{
			caption:"Search",
	...
	//var toolbar = $("#t_newapi_beli_detail"),
	//	t_content = "";
...
<table id="newapi_beli_detail"></table>
<div id="pnewapi_beli_detail"></div>

<br>

<input type='button' value='Process Buying' onclick='proses_beli();'>
<input type='checkbox' id="print_beli"> Print